        ...
        <div className="w-[70%] mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl mb-8">
            ...
            <p className="text-base leading-relaxed">
              ...
              (RGPD), tient dans le temps, et reste simple à gérer au quotidien
              grâce aux bons outils (CMS, créateur de sites, frameworks) et à
          ...
          <div className="prose max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <div className="flex items-center">
                    <span className="font-semibold text-green-700">Site :</span>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="ml-2">vend des produits avec panier</span>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    <span className="font-semibold text-green-700">CMS :</span>
                    <span className="ml-2">système de gestion de contenu</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <ul className="space-y-2 mb-8">
              ...
              <li>
                <strong>Site internet / site web</strong> : même chose en usage
                courant ; site internet est plus employé en français et capte
              ...
              <li>
                <strong>Boutique en ligne (site e‑commerce)</strong> : vend des
                produits ou des services avec panier, paiement, gestion de
                commandes.
              </li>
              <li>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-blue-50 p-6 rounded-xl">
                <h4 className="font-bold text-blue-800 mb-2">1. Crédibilité</h4>
                <p>
              ...
              <div className="bg-purple-50 p-6 rounded-xl">
                <h4 className="font-bold text-purple-800 mb-2">3. Contrôle</h4>
                <p>
                  À la différence d'une simple page sur une plateforme sociale,
                  vous maîtrisez vos données, vos modèles et vos templates.
                </p>
              </div>
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 p-6 rounded-xl mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-4 rounded-lg">
                  <h4 className="font-bold text-orange-700 mb-2">Framework</h4>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl">
                ...
                <p className="text-green-700">
                  Permet de vendre des produits, gérer un compte client, suivre
                  les commandes et accepter différents moyens de paiement.
                </p>
              </div>
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl">
                ...
                <p className="text-purple-700">
                  Répond aux questions des prospects, attire un trafic qualifié
                  via les moteurs de recherche et nourrit les réseaux sociaux.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 p-6 rounded-xl">
                ...
                <p className="text-red-700">
                  Montre des cas concrets avec texte, images, design, résultats
                  et services associés. Indispensable pour les métiers créatifs.
                </p>
              </div>
            ...
            <p className="mb-6">
              Votre site internet doit répondre à deux exigences : être compris
              par l'humain et par les moteurs de recherche. La structure et le
              contenu font 80 % du résultat.
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <span>Tarifs / Devis (transparence, options, forfait)</span>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    ...
                    <span>Contact (formulaire, adresse, email, téléphone)</span>
                  </div>
                  <div className="flex items-center">
                    <span className="bg-indigo-100 text-indigo-800 px-2 py-1 rounded text-sm font-medium mr-2">
                      Page
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl">
                <h4 className="font-bold text-purple-800 mb-3">3. Services</h4>
                <p>
            ...
            <p className="mb-6">
              Le choix des outils dépend de vos objectifs, de votre temps et de
              vos connaissances.
            </p>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-6 rounded-xl mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="bg-white p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Dépendance plateforme, coûts mensuels, limites SEO avancées
                  </p>
                </div>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">50-200€ (optionnel)</span>
                    </div>
                  </div>
                </div>
                <div>
            ...
            <h2 className="text-3xl font-bold text-primary mb-6">
              SEO : optimiser votre site internet pour les moteurs de recherche
            </h2>
            <p className="mb-6">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h4 className="font-bold text-purple-700 mb-2">Technique</h4>
                  <ul className="space-y-1 text-sm">
            ...
            <div className="space-y-6 mb-8">
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <p>
                  Le coût dépend du type de site et des fonctionnalités. Pour un
                  site vitrine professionnel : entre 1 200 € et 3 000 € selon
                  l'ampleur (nombre de pages, design, contenu, SEO,
                  intégrations). Une boutique en ligne démarre souvent à 3 500–6
                  000 € pour un socle solide (catalogue, paiement, livraison).
                  Ajoutez l'hébergement (5–30 €/mois) et les frais d'outils
                  (emails, analytics premium, plugins).
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <p>
                  ...
                  domaine personnalisé, publicités, peu de fonctionnalités, SEO
                  restreint, difficulté d'export. Pour un usage professionnel,
                  prévoyez au moins un forfait de base (domaine + hébergement +
                  thème propre).
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <p>
                  ...
                  global : création (conception + intégration), contenu (textes,
                  images), hébergement, sécurité, et maintenance annuelle. Un
                  bon ordre de grandeur : 1 200–2 400 € (vitrine 5–8 pages) ; 3
                  500–8 000 € (e‑commerce). Les options (réservation, CRM, API,
                  applications) augmentent le budget.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <p>
                  ...
                  (certificats, CDN, emails pro). Certaines plateformes incluent
                  le tout dans un forfait mensuel. Vérifiez la présence d'un
                  essai sans carte bancaire requise.
                </p>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    <span>
                      Design : templates propres, modèles cohérents, expérience
                      mobile
                    </span>
                  </div>
                  <div className="flex items-center">
            ...
            <p className="mb-8 text-lg">
              ...
              contenu, l&apos;expérience, les fonctionnalités, la sécurité et le
              référencement. Avec une méthode réaliste et des outils adaptés (du
              CMS aux outils IA pour gagner du temps), vous obtiendrez un site
              web durable, cohérent, et source régulière de clients. Pour
              découvrir nos{" "}
              <a href="/tarif" className="text-secondary underline font-medium">
                tarifs détaillés
              </a>{" "}
