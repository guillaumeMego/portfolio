              ...
              <ul className="space-y-5 mb-8 text-base">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    vivant ici, j&#39;intègre ces spécificités dans le contenu,
                    le design et la stratégie SEO.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <Zap className="w-6 h-6 text-[#AD5100] flex-shrink-0 mt-1" />
                  <span>
                    <strong>Réactivité et proximité</strong> : Besoin d&#39;un
                    brief express ou d&#39;une séance photo ? Je suis à dix
                    minutes. Cette proximité réduit les aller-retours et
                    accélère les mises en ligne.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    un écosystème éprouvé pour orchestrer l&#39;ensemble de
                    votre projet.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    privilégie la proximité. J&#39;optimise chaque balise et
                    votre fiche Google Business pour verrouiller le
                    positionnement « création site web Angoulême ».
                  </span>
                </li>
                <li className="flex items-start gap-3">
