...
export default function HeroServer() {
  return (
    <div className="text-center max-w-3xl mx-auto mt-24">
      <h1 className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/70 text-4xl md:text-5xl font-bold mb-4">
        Création de site web sur mesure pour les pros exigeants
      </h1>
      <p className="text-base md:text-lg max-w-2xl mx-auto leading-relaxed font-normal">
