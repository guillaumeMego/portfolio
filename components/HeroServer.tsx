...
export default function HeroServer() {
  return (
    <div className="text-center max-w-3xl mx-auto mt-24 px-4 min-h-[80vh] flex flex-col justify-center">
      <div className="flex flex-col items-center justify-center md:flex-row md:gap-6 mb-4">
        <Image
          src="/images/mascotte/mascotte.webp"
          alt="Mascotte Guillaume Ganne"
          width={80}
          height={80}
          className="mb-2 md:mb-0 md:mr-4 w-20 h-20 object-contain drop-shadow-lg"
          priority
        />
        <h1
